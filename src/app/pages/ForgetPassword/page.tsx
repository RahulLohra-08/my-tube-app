    ...
    <div className="mx-auto max-w-md">
              ...
              <div className="grid gap-y-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <p className="mt-2 hidden text-xs text-rose-600 peer-invalid:block" id="email-error">
      ...
      <p className="mt-3 flex items-center justify-center divide-x divide-gray-300 text-center">
        <span className="inline pr-3 text-sm text-gray-600">
          ...
          <a className="font-medium text-blue-600 decoration-2 hover:underline" href="#"> Sign in here </a>
        </span>
        <a
